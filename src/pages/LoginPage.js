...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Check if backend returns both user and access_token
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex space-x-4">
                  {['vendor', 'supplier'].map((roleOption) => (
                    <label key={roleOption} className="flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, role: e.target.value, identifier: '' })
                        }
                        className="mr-2 text-green-600"
                      />
                      <span className="text-gray-700 capitalize">{roleOption}</span>
                    </label>
                  ))}
                </div>
              </div>
